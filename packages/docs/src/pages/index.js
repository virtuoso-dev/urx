...
const features = [
  {
    ...
    description: <>Stream systems describe UI logic in a natural, declarative form.</>,
  },
  {
    title: <>Framework Agnostic. Fit for React</>,
    imageUrl: 'img/decoration2.svg',
    description: <>Expose stream systems as React components. No more hook spaghetti.</>,
  },
  {
    title: <>Compatible with Your Reality</>,
    imageUrl: 'img/decoration3.svg',
    description: <>Play it safe and port a few pieces of your code to urx. Keep your existing state management for the rest.</>,
  },
]
      ...
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        <div className="container">
          ...
          <div className={styles.buttons}>
            <Link className={clsx('button button--primary button--lg', styles.getStarted)} to={useBaseUrl('docs/get_started/')}>
              Get Started
            </Link>
          </div>
        </div>
